...
- Fixes the length of the text displayed for the 'source page' and for 'conversation id'
- Manages the 'take a shortcut' section present in the home header in case the user role is agent and in case the 'App-store' is not enabled
