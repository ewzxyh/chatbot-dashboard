...
### 2.1.1
- Replaces in users list profile image placeholder with avatar generated by user initials
- Fixes requester presence
...
- Adds in user profile the ability to disable / enable to receive emails when a conversation is unassigned
- Adds the ability to know served requests geolocation
