...
export const environment = {
  production: false,
  remoteConfig: false, 
  t2y12PruGU9wUtEGzBJfolMIgK: 'PAY:T-ANA:T-ACT:T-TRI:T-GRO:T-DEP:T-OPH:T-MTL:T-CAR:T-V1L:T-PSA:T-MTT:T-SUP:T-LBS:T-APP:T-DEV:T-NOT:T-IPS:T-ETK:T-RAS:T-PPB:T-PET:T-MTS:T-TIL:T-DGF:T-NAT:T-HPB:F-TOW:T-KNB:T-BAN:T-AST:T-MON:T-CNT:T',
  VERSION: require('../../package.json').version,
  ...
  appsUrl: "https://tiledesk-apps-server-temp.giovannitroisi3.repl.co/",// "https://tiledesk-apps-server2.giovannitroisi3.repl.co/", //"https://tiledesk-apps-server-test.giovannitroisi3.repl.co/", // "https://tiledesk-apps-server.giovannitroisi3.repl.co/",// "https://tiledesk-apps.herokuapp.com/",
  cdsBaseUrl: "/cds/", //'/new-cds/',
  whatsappApiUrl: "https://tiledesk-whatsapp-connector.giovannitroisi3.repl.co/", // "https://tiledesk-whatsapp-app-pre.giovannitroisi3.repl.co",
