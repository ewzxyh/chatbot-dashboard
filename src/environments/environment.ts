...
export const environment = {
    ...
    CHAT_BASE_URL: 'http://panel.tiledesk.com/v3/chat/', // 'http://localhost:8102/', // 'https://console.tiledesk.com/v2/chat5-dev/', // 'http://console.tiledesk.com/v2/chat/', 
    ...
    globalRemoteJSSrc: "http://panel.tiledesk.com/v3/scripts/script.js, http://panel.tiledesk.com/v3/scripts/custom_script.js, http://panel.tiledesk.com/v3/scripts/segment_script.js",
    firebaseAuth: false,
    uploadEngine: 'native',
