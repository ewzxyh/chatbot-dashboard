...
// export const environment = {
//   production: true,
//   t2y12PruGU9wUtEGzBJfolMIgK: 'PAY:T-ANA:T-ACT:T-TRI:T-GRO:T-DEP:T-OPH:T-MTL:T-CAR:T-V1L:T-PSA:T-MTT:T-SUP:T-LBS:T-APP:T-DEV:T-NOT:T-IPS:T-ETK:T-RAS:T-PPB:T-PET:T-MTS:T-TIL:T-DGF:T-NAT:T-HPB:F-TOW:T-KNB:T-BAN:T-AST:T-MON:T-CNT:T-AUT:T-WUN:T-INT:T-QIN:T-VAU:T', // -DPA:F no more used
...
//   cdsBaseUrl: 'https://panel.tiledesk.com/v3/cds/testn/', //  'https://panel.tiledesk.com/v3/cds/dashboard/', // 'v3/cds',
...
export const environment = { 
  ...
  aiModels: 'gpt-3.5-turbo:0.6;gpt-4:25;gpt-4-turbo-preview:12;gpt-4o:6',
  whatsappConfigUrl: "http://35.198.150.252/api/modules/whatsapp/configure",
  messengerConfigUrl: "http://35.198.150.252/api/modules/messenger/configure",
  telegramConfigUrl: "http://35.198.150.252/api/modules/telegram/configure",
  voiceConfigUrl: "http://35.198.150.252/api/modules/voice/manage/configure",
  smsConfigUrl: "http://35.198.150.252/api/modules/sms/manage/configure",
  firebase: { }
}
