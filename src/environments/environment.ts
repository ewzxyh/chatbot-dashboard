...
// 'PAY:F-ANA:F-ACT:F-TRI:T-GRO:F-DEP:F-OPH:F-MTL:T-CAR:F-V1L:T-PSA:F-MTT:T-SUP:T-LBS:T-APP:T-DEV:F-NOT:T-IPS:F-ETK:F-RAS:T-PPB:F-PET:F-MTS:F-TIL:T-DGF:T-NAT:T-HPB:F-TOW:T-KNB:T-BAN:F-AST:F-MON:F-CNT:F',
// -------------------------------------------------------------
// export const environment = {
//   production: false,
...
//   appsUrl: "https://tiledesk-apps-server-temp.giovannitroisi3.repl.co/", // "https://tiledesk-apps.herokuapp.com/",
