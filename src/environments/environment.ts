...
export const environment = {
    ...
    //   remoteConfigUrl:'./dashboard-pre-config-nofb.json',
    ...
    // globalRemoteJSSrc:'https://api.filestackapi.com/filestack.js, ../../../assets/dummy_script.js',
    // firebase: {
    //     apiKey: 'CHANGEIT',
    //     authDomain: 'CHANGEIT',
    ...
    t2y12PruGU9wUtEGzBJfolMIgK: "PAY:T-ANA:T-ACT:T-TRI:T-GRO:T-DEP:T-OPH:T-MTL:T-DGF:T-NAT:T-CAR:T-V1L:T-PSA:T-MTT:T-SUP:T-LBS:T-APP:T",
    widgetUrl: "https://widget-pre.tiledesk.com/v2/launch.js",
    ...
    CHAT_BASE_URL: "https://support-pre.tiledesk.com/chat/index.html",
    ...
    globalRemoteJSSrc:"https://tiledeskcustomscript.nicolan74.repl.co/script.js",
    firebase: {
