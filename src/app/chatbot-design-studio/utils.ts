...
export const ACTIONS_LIST= {
    ...
    INTENT : { name: 'Connect intent', type: TYPE_ACTION.INTENT, src:"assets/cds/images/actions/connect_intent.svg", description: 'This action moves the flow to the specified intent.<br> Keep in mind that if there are other actions in the current intent actions-pipeline they will be executed too, generating a parallel-execution of all the branches affering to each intent triggered through this Connect-intent action.'},
    CONDITION : { name: 'Condition', type: TYPE_ACTION.CONDITION, src:"assets/cds/images/actions/condition.svg"},
    ASSIGN_VARIABLE : { name: 'Set attribute', type: TYPE_ACTION.ASSIGN_VARIABLE, src:"assets/cds/images/actions/delete_var.svg"},
    DELETE_VARIABLE : { name: 'Delete attribute', type: TYPE_ACTION.DELETE_VARIABLE, src:"assets/cds/images/actions/hidden_message.svg"},
