...
export const ELEMENTS_LIST = [
    ...
    { name: 'Send email', type: TYPE_ACTION.EMAIL, src:"assets/cds/images/actions/send_email.svg", description: 'This action send an email to the specified users group or email addresses.<br>You can use a comma sepatated addresses list.<br>i.e. redacted@example.invalid, redacted@example.invalid"<br>You can use the special tag “@everyone” to send an email to each of the Tiledesk’s project teamates.<br><br>You can also use the name of a single user group using the group name. i.e. “sales”'},
    { name: 'Template WABA', type: TYPE_ACTION.WHATSAPP_STATIC, src: "assets/cds/images/actions/whatsapp.svg", description: 'Envia um template aprovado pela Meta/WABA' },
    { name: 'Template WABA por atributo', type: TYPE_ACTION.WHATSAPP_ATTRIBUTE, src: "assets/cds/images/actions/whatsapp.svg", description: 'Envia um template Meta/WABA escolhido por atributo' },
    { name: 'Template WABA por segmento', type: TYPE_ACTION.WHATSAPP_SEGMENT, src: "assets/cds/images/actions/whatsapp.svg", description: 'Envia um template Meta/WABA escolhido por segmento' },
...
export const ACTIONS_LIST= {
    ...
    WHATSAPP_STATIC: { name: 'Template WABA', type: TYPE_ACTION.WHATSAPP_STATIC, src: "assets/cds/images/actions/whatsapp.svg", description: 'Envia um template aprovado pela Meta/WABA' },
    WHATSAPP_ATTRIBUTE: { name: 'Template WABA por atributo', type: TYPE_ACTION.WHATSAPP_ATTRIBUTE, src: "assets/cds/images/actions/whatsapp.svg", description: 'Envia um template Meta/WABA escolhido por atributo' },
    WHATSAPP_SEGMENT: { name: 'Template WABA por segmento', type: TYPE_ACTION.WHATSAPP_SEGMENT, src: "assets/cds/images/actions/whatsapp.svg", description: 'Envia um template Meta/WABA escolhido por segmento' },
