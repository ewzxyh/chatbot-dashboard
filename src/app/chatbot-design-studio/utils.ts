...
export const ACTIONS_LIST= {
    ...
    INTENT : { name: 'Connect block', type: TYPE_ACTION.INTENT, src:"assets/cds/images/actions/connect_intent.svg", description: 'This action moves the flow to the specified intent.<br> Keep in mind that if there are other actions in the current intent actions-pipeline they will be executed too, generating a parallel-execution of all the branches affering to each intent triggered through this Connect-intent action.'},
