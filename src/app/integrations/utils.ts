...
export const INTEGRATION_LIST_ARRAY = [
    { name: "Brevo",                 category: INTEGRATIONS_CATEGORIES.CRM,              key: INTEGRATIONS_KEYS.BREVO,           src_icon: "assets/img/int/brevo-icon.png",                  src_logo: "assets/img/int/brevo-logo.png",              pro: true,  plan: 'Pro' },
    { name: "N8N",                   category: INTEGRATIONS_CATEGORIES.INT_PLAT,         key: INTEGRATIONS_KEYS.N8N,             src_icon: "assets/img/int/n8n-icon.svg",                    src_logo: "assets/img/int/n8n-logo.png",                pro: true,  plan: 'Starter'},
    { name: "Customer.io",           category: INTEGRATIONS_CATEGORIES.CRM,              key: INTEGRATIONS_KEYS.CUSTOMERIO,      src_icon: "assets/img/int/customerio-icon_new.png",         src_logo: "assets/img/int/customerio-logo_new.svg",     pro: true,  plan: 'Pro' },
    ...
    { name: "Make",                  category: INTEGRATIONS_CATEGORIES.INT_PLAT,         key: INTEGRATIONS_KEYS.MAKE,            src_icon: "assets/img/int/make-icon.png",                   src_logo: "assets/img/int/make-logo.svg",               pro: true,  plan: 'Starter'},
    { name: "Messenger",             category: INTEGRATIONS_CATEGORIES.CHANNEL,          key: INTEGRATIONS_KEYS.MESSENGER,       src_icon: "assets/img/int/messenger-icon.png",              src_logo: "assets/img/int/messenger-logo.jpeg",         pro: true,  plan: 'Pro' },
    ...
    { name: "CaseZap",               category: INTEGRATIONS_CATEGORIES.CHANNEL,          key: INTEGRATIONS_KEYS.CASEZAP,         src_icon: "assets/img/int/whatsapp-icon.png",               src_logo: "assets/img/int/whatsapp-logo.png",           pro: false, plan: 'Sandbox' },
