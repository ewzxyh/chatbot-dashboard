...
export class TemplatesComponent implements OnInit {
  ...
  // curl -v -X GET -H 'Content-Type:application/json' -u redacted@example.invalid:258456td  'https://tiledesk-server-pre.herokuapp.com/63c824ec8216d50035b2b04a/bots/?text=ciao2'
