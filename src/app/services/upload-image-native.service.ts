...
export class UploadImageNativeService {
  ...
  // curl -v -X PUT -u redacted@example.invalid:258456td \
  ...
  // curl -v -X PUT -u redacted@example.invalid:258456td   -F "file=@/Users/andrealeo/dev/chat21/tiledesk-server-dev-org/test.jpg"  
  ...
  // curl -v -X DELETE  -u redacted@example.invalid:258456td \
