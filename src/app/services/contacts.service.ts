...
export class ContactsService {
  ...
  // curl -v -X PATCH -H 'Content-Type:application/json' -u redacted@example.invalid:258456td -d '{"a1":"a2", "b1":"b2"}' http://localhost:3000/6307a210f6c98c2d6c9c74ef/leads/630e19bf8ddb5f633abfedbf/properties
